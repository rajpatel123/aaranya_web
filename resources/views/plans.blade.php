...
<body <?php if (Session::has('dark_mode')) {
      ...
      <div class="container">
         <div class="header justify-content-between d-flex">
            <div class="logo">
               ...
               <!-- <a href="  "><img src="assets/img/arnya/aaranya-logo.svg" /></a> -->
   ...
   <main id="main" style="margin-top:0px;">
                     ...
                     <div class="row marg0">
                        <div class="col-sm-2.8">
                           <div class="packageLeftBar">
                              <ul>
                                 <li>Therapies</li>
                                 <li> Therapy Sessions per month</li>
                                 <li> Lifestyle Diseases</li>
                                 <li>Hair & skin related disorders</li>
                                 <li>Stomach related disorders</li>
                                 <li>Allergy</li>
                                 <li>Women wellness</li>
                                 <li>Stress & Millennials package</li>
                                 <li>Yoga</li>
                                 <li>Dietician</li>
                                 <li>Zumba</li>
                                 <li>Fun Friday</li>
                                 <li>Counselling Sessions for Seniors</li>
                                 <li>Counselling sessions</li>
                                 <li>Healthy Family</li>
                                 <li>Computer Related Injuries Rehabilitation</li>
                                 <li>Habit Module</li>
                                 <li>Yearly Planner</li>
                                 <li>Habit Module</li>
                        ...
                        <div class="col-sm-1.8">
                           <div class="packageDetails yellow">
                              <ul>
                                 ...
                                 <li><i class="fa fa-times"></i></li>
                                 <li><i class="fa fa-times"></i></li>
                                 <li class="blank"><i class="fa fa-times"></i></li>
                                 <li><i class="fa fa-times"></i></li>
                                 <li><i class="fa fa-times"></i></li>
                                 <li class="blank"><i class="fa fa-times"></i></li>
                                 <li><i class="fa fa-times"></i></li>
                        ...
                        <div class="col-sm-1.8">
                           <div class="packageDetails yellow">
                              <ul>
                                 ...
                                 <li>4 Per Month</li>
                                 <li>4 Per Month</li>
                                 <li class="blank">10 Per Month</li>
                                 <li>2 Per Month</li>
                                 <li>2 Per Month</li>
                                 <li class="blank">4 Per Month</li>
                                 <li><i class="fa fa-times"></i></li>
                                 <li><i class="fa fa-times"></i></li>
                                 <li><i class="fa fa-times"></i></li>
      ...
      <!--ends container-->
      <!--===================================================section 9  Ends========================================================================================-->
      <div class="request-a-demo" style="">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <center><img src="assets/img/solution/logo2.svg" style="width: 10%;"></center>
                  <h2>Request A Demo</h2>
                  <p>5 day complimentary demo for corporates</p>
                  <center> <button class="btn success">START HERE</button> </center>
               </div>
               <!--col ends-->
            </div>
            <!--row ends-->
      ...
      <script src="assets/vendor/owl.carousel/owl.carousel.min.js"></script> <!-- Template Main JS File -->
